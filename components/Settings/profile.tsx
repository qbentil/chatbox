...
const Profile = () => {
    ...
    return (
        <View style = {[tw`flex-row justify-between items-center my-3 bg-gray-900 py-4 px-2 border-t border-b`, {borderColor: Colors[colorScheme].backgroundOpac, borderTopWidth: 0.3, borderBottomWidth: 0.3}]}>
