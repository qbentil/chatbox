    ...
    >
      <TouchableNativeFeedback onPress={Keyboard.dismiss} >
        <View style = {tw`flex flex-row justify-between px-5 py-3 w-100 items-end`}>
          <TouchableOpacity activeOpacity={.7} style = {tw`mb-1`}>
          ...
          <View style = {tw`flex flex-row justify-between w-[40px] mb-1`}>
            <TouchableOpacity activeOpacity={.7} style = {tw`mx-1`} >
            ...
            <View>
              <TouchableOpacity activeOpacity={.7} style = {tw` ml-1 p-1 flex items-center justify-center rounded-full h-7 w-7 bg-[${Colors.light.tint}]`}>
